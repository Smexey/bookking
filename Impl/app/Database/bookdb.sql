...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2020 at 02:36 PM
...
(1, 'admin@gmail.com', 'admin123', 'admin', 'admin', 'Nepoznato', 'Nepoznato', 'Nepoznato', 0, 4),
...
(5, 'pasajlic.janko@gmail.com', 'janko123', 'Janko', 'Pasajlic', 'Svetog Save 1', 'Raska', 'Srbija', 36350, 1);
...
--
ALTER TABLE `kupovina`
  MODIFY `IdKup` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `nacinkupovine`
--
ALTER TABLE `nacinkupovine`
...
--
-- AUTO_INCREMENT for table `stanjeoglasa`
--
ALTER TABLE `stanjeoglasa`
...
--
-- AUTO_INCREMENT for table `zahtevver`
--
ALTER TABLE `zahtevver`
