...
<head>
    ...
    <link rel="icon" href="http://localhost/bookking/Impl/favicon.ico" type="image/ico">
    ...
    <nav class="navbar navbar-expand-lg fixed-top  ">
        ...
        <div class="collapse navbar-collapse homePageMenu" id="navbarNav">
            <ul class="navbar-nav ml-lg-auto">
                <li class="nav-item">
                    <a href="<?php echo site_url("Gost/pretraga"); ?>" class="nav-link smoothScroll">Pretraga</a>
                </li>

                <li class="nav-item">
                    <a href="<?php echo site_url("Gost/nalog"); ?>" class="nav-link smoothScroll">Moj nalog</a>
                </li>

                <li class="nav-item">
                    <a href="<?php echo site_url("Gost/login"); ?>" class="nav-link smoothScroll">Uloguj se</a>
                </li>

                <li class="nav-item">
                    <a href="<?php echo site_url("Gost/o_nama"); ?>" class="nav-link smoothScroll">O nama</a>
                </li>
            </ul>
