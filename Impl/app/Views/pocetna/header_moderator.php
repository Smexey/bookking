...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top  ">
        ...
        <a class="navbar-brand" href="<?php echo site_url("Moderator/index"); ?>">BookKing!</a>
        ...
        <div class="collapse navbar-collapse homePageMenu" id="navbarNav">
            <ul class="navbar-nav ml-lg-auto">
                <li class="nav-item">
                    <a href="<?php echo site_url("Moderator/pretraga"); ?>" class="nav-link smoothScroll">Pretraga</a>
                </li>
                ...
                <li class="nav-item">
                    <a href="<?php echo site_url("Moderator/poruke"); ?>" class="nav-link smoothScroll">Poruke</a>
                </li>
                ...
                <li class="nav-item">
                    <a href="<?php echo site_url("Moderator/o_nama"); ?>" class="nav-link smoothScroll">O nama</a>
                </li>
            </ul>
