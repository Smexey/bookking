<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg fixed-top  ">
                ...
                <a class="navbar-brand" href="<?php echo site_url("Korisnik/index"); ?>">BookKing!</a>
                ...
                <div class="collapse navbar-collapse homePageMenu" id="navbarNav">
                    <ul class="navbar-nav ml-lg-auto">
                        <li class="nav-item">
                            <a href="<?php echo site_url("Korisnik/pretraga"); ?>" class="nav-link smoothScroll">Pretraga</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo site_url("Korisnik/logout"); ?>" class="nav-link smoothScroll">Izloguj se</a>
                        </li>

                        <li class="nav-item">
                            <a href="<?php echo site_url("Korisnik/o_nama"); ?>" class="nav-link smoothScroll">O nama</a>
                        </li>
                    </ul>
